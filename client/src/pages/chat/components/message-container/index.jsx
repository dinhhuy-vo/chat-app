...
const MessageContainer = () => {
  ...
  const checkIfImage = (filePath) => {
    const imageRegex =
      /\.(jpg|jpeg|png|gif|bmp|avif|tiff|tif|webp|svg|ico|heic|heif)$/i;
          ...
          <div
            className={`${
              message.sender !== selectedChatData._id
                ? "bg-[#8417ff]/5 text-[#8417ff]/90 border-[#8417ff]/50 rounded-xl"
                : "bg-[#2a2b33]/5 text-white/80 border-[#ffffff]/20 rounded-xl"
            } border inline-block p-4 rounded-none my-1 max-w-[50%] break-words`}
          >
            {message.content}
          </div>
        )}
          ...
          <div
            className={`${
              message.sender._id === userInfo.id
                ? "bg-[#8417ff]/5 text-[#8417ff]/90 border-[#8417ff]/50 rounded-xl"
                : "bg-[#2a2b33]/5 text-white/80 border-[#ffffff]/20 rounded-xl"
            } border inline-block p-4 rounded-none my-1 max-w-[50%] break-words ml-9`}
          >
            {message.content}
          </div>
        )}
